...
hhs.set_index('date').sort_index().loc[pd.Timestamp('2020-09-01'):][select_cols].sum(axis=1).reset_index().rename({0:'value'},axis=1).to_csv('va_covid_admissions.csv',index=None)
